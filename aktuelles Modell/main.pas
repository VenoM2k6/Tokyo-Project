...
begin
  ...
  else if (setType2.ItemIndex = 1) and (elongation2cache > 0) and (mass2cache > 0) and (featherkonstant2cache > 0) and (damping2cache > 0) then begin
    ChartLineSeries2.clear;
    m := mass2cache;
    D := featherkonstant2cache;
    y := elongation2cache;
  ...
  else if (setType2.ItemIndex = 2) and (mass2cache > 0) and (elongation2cache > 0) and (length2cache > 0) and (locationfactor2cache > 0) then begin
    ChartLineSeries2.clear;
    m := mass2cache;
    y := elongation2cache;
    l := length2cache;
  ...
  else if (setType2.ItemIndex = 3) and (mass2cache > 0) and (elongation2cache > 0) and (length2cache > 0) and (locationfactor2cache > 0) and (length2cache > 0) then begin
    ChartLineSeries2.clear;
    m := mass2cache;
    y := elongation2cache;
    k := damping2cache;
...
begin
  ...
  else if (setType3.ItemIndex = 1) and (elongation3cache > 0) and (mass3cache > 0) and (featherkonstant3cache > 0) and (damping3cache > 0) then begin
    ChartLineSeries3.clear;
    m := mass3cache;
    D := featherkonstant3cache;
    y := elongation3cache;
  ...
  else if (setType3.ItemIndex = 2) and (mass3cache > 0) and (elongation3cache > 0) and (length3cache > 0) and (locationfactor3cache > 0) then begin
    ChartLineSeries3.clear;
    m := mass3cache;
    y := elongation3cache;
    l := length3cache;
  ...
  else if (setType3.ItemIndex = 3) and (mass3cache > 0) and (elongation3cache > 0) and (length3cache > 0) and (locationfactor3cache > 0) and (length3cache > 0) then begin
    ChartLineSeries3.clear;
    m := mass3cache;
    y := elongation3cache;
    k := damping3cache;
